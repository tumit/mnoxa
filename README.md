...
```bash
curl -fsSL https://raw.githubusercontent.com/tumit/mnox/main/scripts/mnoxa.sh | bash
```
...
```bash
curl -fsSL -o mnoxa.sh https://raw.githubusercontent.com/tumit/mnox/main/scripts/mnoxa.sh
bash mnoxa.sh
```
